...
class FaunoTestCase(unittest.TestCase):
    ...
    def test_fauno_es_atacable(self):
    ...
    def test_fauno_es_atacante(self):
        ...
        m_atacar.assert_called_once_with(objetivo)

    def test_fauno_inicia_con_resistencia_100_predeterminada(self):
        self.assertEqual(100, self.fauno.resistencia)

    def test_fauno_inicia_con_resistencia_especifica(self):
        self.fauno = Fauno(50)
        self.assertEqual(50, self.fauno.resistencia)

    def test_fauno_con_escudo_no_reduce_resistencia(self):
    ...
    def test_inicia_con_resistencia_0_arroja_value_error_en_primer_ataque(self):
        self.fauno = Fauno(0)
